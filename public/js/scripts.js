...
(function($) {
    ...
    function initMenu(){
        ...
        $(".navigation li").each(function(){
            ...
            var pathArr = window.location.pathname.match(re)
            var hrefArr = href.match(re)

            if(pathArr){
                if(pathArr[1] == hrefArr[1]){
                    menuItem.addClass('current-menu-item')
                }
            }
            else if( hrefArr[1] == "de"){
                menuItem.addClass('current-menu-item')
            }     
        })
    }
    ...
    $(document).ready(function() {
        ...
        $('.web-cams').magnificPopup({
            items: [
              {
                src: 'https://s3-eu-west-1.amazonaws.com/felsenegg-cam/cam0.jpg'
              },
              {
                src: 'https://s3-eu-west-1.amazonaws.com/felsenegg-cam/cam1.jpg'
              }
            ],
            type: 'image',
            gallery: {
